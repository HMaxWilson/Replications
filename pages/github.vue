<template>
  <div class="text-gray-900 text-sm">
    <nav class="bg-gray-900 text-white px-4 py-3 flex items-center justify-between">
      ...
      <div class="flex items-center space-x-4 text-white">
        <a href="#" class="relative hover:text-gray-400">
          <svg class="w-5 fill-current" viewBox="0 0 16 16">
        ...
        <a href="#" class="hidden lg:flex items-center hover:text-gray-400">
          <svg class="w-4 fill-current" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M7.75 2a.75.75 0 01.75.75V7h4.25a.75.75 0 110 1.5H8.5v4.25a.75.75 0 11-1.5 0V8.5H2.75a.75.75 0 010-1.5H7V2.75A.75.75 0 017.75 2z"></path>
          </svg>
          <svg class="w-3 ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
          </svg>
        </a>
        <a href="#" class="flex items-center hover:text-gray-400">
          <img class="w-5 h-5 rounded-full" src="https://avatars.githubusercontent.com/u/33638862?s=40&amp;v=4" alt="@HMaxWilson" size="20">
          <svg class="w-3 ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
          </svg>
        </a>
    ...
    <div class="repo-stats flex flex-col lg:flex-row items-center justify-between px-8 py-4">
      ...
      <div class="hidden md:flex mt-4 lg:mt-0 space-x-2">
        <div class="flex text-xs">
          <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 flex items-center space-x-1">
            <svg class="fill-current text-gray-600 w-4" viewBox="0 0 16 16">
            ...
            <div>Watch</div>
            <svg class="w-3 fill-current ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
            </svg>
          </button>
    ...
    <ul class="repo-nav border-b border-gray-400 flex items-center px-8 mt-4">
      <li class="font-semibold">
        <a href="#" class="flex items-center border-b-2 border-red-500 px-4 pb-3">
          <svg class="fill-current w-4" viewBox="0 0 16 16">
      ...
      <li>
        <a href="#" class="flex items-center border-b-2 border-transparent hover:border-gray-400 transition ease-in-out duration-150 px-4 pb-3">
          <svg class="fill-current w-4 text-gray-600" viewBox="0 0 16 16">
      ...
      <li>
        <a href="#" class="hidden lg:flex items-center border-b-2 border-transparent hover:border-gray-400 transition ease-in-out duration-150 px-4 pb-3">
          <svg class="fill-current w-4 text-gray-600" viewBox="0 0 16 16">
    ...
    <div class="container mx-auto my-8 px-4 flex flex-col lg:flex-row lg:mr-8">
      <div class="file-explorer-container w-full lg:w-3/4 mr-8">
        <div class="branch-navigation flex items-center justify-between">
          <div class="flex items-center space-x-2">
            <button class="border border-gray-400 rounded-md px-4 py-1 bg-gray-100 hover:bg-gray-200 flex items-center space-x-2">
              ...
              <div class="font-semibold text-gray-600">main</div>
              <svg class="w-3 fill-current text-gray-600 ml-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
              </svg>
            </button>
            <a href="#" class="hidden lg:flex items-center space-x-2 px-3 py-1 group">
              ...
              <span class="group-hover:text-blue-600">
                <span class="font-semibold group-hover:text-blue-600">25</span>
            ...
            <a href="#" class="hidden lg:flex items-center space-x-2 px-3 py-1 group">
              ...
              <span class="group-hover:text-blue-600">
                <span class="font-semibold group-hover:text-blue-600">79</span>
                <span class="text-gray-600 group-hover:text-blue-600">tags</span>
              </span>
            </a>
          </div>
          <div class="hidden lg:flex items-center space-x-2 font-semibold">
            <button class="border border-gray-400 bg-gray-100 hover:bg-gray-200 rounded px-4 py-1 flex items-center space-x-2">
              <div>Go to file</div>
            </button>
            <button class="border border-gray-400 bg-gray-100 hover:bg-gray-200 rounded px-4 py-1 flex items-center space-x-2">
              <div>Add file</div>
            ...
            <button class="border border-gray-400 text-white bg-green-600 hover:bg-green-700 rounded px-4 py-1 flex items-center space-x-2">
              <svg class="w-4 fill-current text-gray-200" viewBox="0 0 16 16">
        ...
        <div class="commits-container bg-blue-100 rounded-md rounded-b-none border border-blue-200 border-b-0 flex items-center justify-between px-4 py-4 mt-5">
          <div class="flex items-center space-x-2">
            <img class="w-5 h-5 rounded-full" src="https://avatars.githubusercontent.com/u/33638862?s=40&amp;v=4" alt="@HMaxWilson" size="20">
            <a href="#" class="font-semibold hover:underline">HMaxWilson</a>
          ...
          <div class="flex items-end">
            ...
            <a href="#" class="font-mono text-xs text-gray-600 hover:underline hover:text-blue-500 ml-2 hidden lg:block">5b2c062</a>
            <a href="#" class="text-gray-600 hover:underline hover:text-blue-500 ml-2">3 hours ago</a>
        ...
        <div class="file-explorer rounded-md rounded-t-none border border-gray-400 text-gray-700 divide-y divide-gray-400">
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12 flex items-center">
              <svg class="w-4 fill-current text-blue-400" viewBox="0 0 16 16">
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12 flex items-center">
              ...
              <a href="#" class="hover:underline hover:text-blue-500 ml-3">public</a>
            </div>
            <div class="w-6/12 truncate hidden lg:block">Newest public build</div>
            <div class="w-4/12 lg:w-2/12 text-right">just now</div>
          </div>
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12 flex items-center">
              <svg class="w-4 fill-current text-blue-400" viewBox="0 0 16 16">
            ...
            <div class="w-6/12 truncate hidden lg:block">Applied new source images to project, populating product pages with new content, this will allow for more sale of these items</div>
          ...
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12 flex items-center">
              ...
              <a href="#" class="hover:underline hover:text-blue-500 ml-3">.eslint.cjs</a>
            </div>
            <div class="w-6/12 truncate hidden lg:block">Initial Commit</div>
            <div class="w-4/12 lg:w-2/12 text-right">11 days ago</div>
          </div>
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12 flex items-center">
              ...
              <a href="#" class="hover:underline hover:text-blue-500 ml-3">index.html</a>
            </div>
            <div class="w-6/12 truncate hidden lg:block">Initial Commit</div>
            <div class="w-4/12 lg:w-2/12 text-right">11 days ago</div>
          </div>
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            ...
            <div class="w-6/12 truncate hidden lg:block">newest scripts</div>
            <div class="w-4/12 lg:w-2/12 text-right">2 days ago</div>
          </div>
          <div class="flex justify-between px-4 py-2 hover:bg-gray-200">
            <div class="w-4/12 flex items-center">
              <svg class="w-4 fill-current text-gray-700" viewBox="0 0 16 16">
            ...
            <div class="w-6/12 truncate hidden lg:block">project README file</div>
            <div class="w-4/12 lg:w-2/12 text-right">20 days ago</div>
          </div>
        </div>
        <div class="readme-container rounded-md border border-gray-400 px-4 py-4 mt-4">
          <h4 class="font-semibold">README.md</h4>
          <div v-html="readme" class="prose max-w-none px-4"/>
        </div>
